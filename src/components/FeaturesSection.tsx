    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10 md:mb-12">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-3xl mx-auto mb-3 leading-relaxed">
            Everything you need to build, deploy, and scale AI-powered customer support. 
            Our comprehensive platform combines cutting-edge artificial intelligence with 
            intuitive design, giving you the tools to transform how you interact with customers.
          </p>
          <p className="text-sm md:text-base text-gray-500 max-w-2xl mx-auto">
            From custom AI training to advanced analytics, we provide enterprise-grade solutions 
            that grow with your business. Join thousands of companies already using ChatFlow AI 
            to reduce costs, improve satisfaction, and scale their support operations effortlessly.
          </p>
        </div>
        ...
        >
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-6 md:p-7 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-primary/20 group relative overflow-hidden flex flex-col"
